...
if ( ! class_exists( 'foodica_CSS' ) ) :
    ...
    class foodica_CSS {
        ...
        /**
         * The one instance of foodica_CSS.
         *
         * @var   foodica_CSS    The one instance for the singleton.
         */
        ...
        /**
         * Instantiate or return the one foodica_CSS instance.
         *
         * @return foodica_CSS
         */
        ...
        public function add( $data ) {
             ...
             * @param array    $data    The selectors and properties to add to the CSS.
             */
            $data  = apply_filters( 'foodica_css_add', $data );
        ...
        private function parse_declarations( $declarations, $tab = '' ) {
             ...
             * routines are implemented when the developer calls `foodica_get_css->add()`. Because every property value has
            ...
            foreach ( $declarations as $property => $value ) {
                 ...
                 */
                $output .= apply_filters( 'foodica_parse_declaration', $parsed_value, $property, $value, $t, $n );
            }
             ...
             */
            return apply_filters( 'foodica_css_parse_declarations', $output, $declarations, $tab );
        }
    }
endif;

if ( ! function_exists( 'foodica_get_css' ) ) :
    /**
     * Return the one foodica_CSS object.
     *
     * @return foodica_CSS    The one foodica_CSS object.
     */
    function foodica_get_css() {
        return foodica_CSS::instance();
    }
endif;

add_action( 'init', 'foodica_get_css', 1 );