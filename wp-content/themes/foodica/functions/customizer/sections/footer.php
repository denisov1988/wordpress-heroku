...
function foodica_customizer_define_footer_sections( $sections ) {
    ...
    $footer_sections['footer'] = array(
        ...
        'options' => array(
            'footer-widget-areas' => array(
                'setting' => array(
                    'sanitize_callback' => 'foodica_sanitize_choice',
                ),
                'control' => array(
...
add_filter( 'zoom_customizer_sections', 'foodica_customizer_define_footer_sections' );
