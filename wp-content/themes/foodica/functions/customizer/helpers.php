...
function foodica_sanitize_choice( $value, $setting ) {
    return $value;
}
 ...
 */
function foodica_sanitize_text( $string ) {
    global $allowedtags;
     ...
     */
    apply_filters( 'foodica_sanitize_text_allowed_tags', $expandedtags, $string );
