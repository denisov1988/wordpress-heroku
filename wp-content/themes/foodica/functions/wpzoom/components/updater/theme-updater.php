...
class WPZOOM_Theme_Updater {
    ...
    public static function notification() {
        ...
        echo sprintf(__('A new version of <a href="%s">%s</a> theme is available. ', 'wpzoom'), $update_url, WPZOOM::$themeName);
        echo sprintf(__('<u><a href="%s" class="thickbox thickbox-preview">Check out what\'s new</a></u> or visit our tutorial on <u><a href="%s">updating themes</a></u>.', 'wpzoom'), 'http://wploy.wpzoom.com/changelog/' . WPZOOM::$theme_raw_name . '?TB_iframe=true', 'http://www.wpzoom.com/tutorial/how-to-update-a-wpzoom-theme/');
        echo ' <input type="button" class="close button" value="' . __('Hide', 'wpzoom') . '" /></div>';
    }
