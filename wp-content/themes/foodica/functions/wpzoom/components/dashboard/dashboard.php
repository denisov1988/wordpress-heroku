...
<div class="table table_news">
    <p class="sub"><?php _e('From our Blog', 'wpzoom'); ?></p>
...
<div class="table table_theme">
    ...
    <a href="http://wpzoom.com/themes/" target="_blank" alt="<?php _e('Browse our wide selection of WordPress themes to find the right one for you', 'wpzoom'); ?>" class="button"><?php _e('Browse more &rarr;', 'wpzoom'); ?></a>
</div>
